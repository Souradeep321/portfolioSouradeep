...
const Contact = () => {
  ...
  return (
    <section className="relative w-screen h-full bg-[#fafafa] dark:bg-[#000000] overflow-x-hidden">
      <div className="relative w-full h-full md:w-[90%] 2xl:w-[50%]  mx-auto bg-white dark:bg-[#18181b] p-4 md:p-6 lg:p-12 flex flex-col gap-10 md:gap-14  shadow-lg transition-all duration-300">
